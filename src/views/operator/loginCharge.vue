<template>
  <div class="login-wrap">
    ...
    <div class="login-content ">
      <group>
        <x-input placeholder="请输入账号" v-model="username" novalidate :show-clear="false">
          <img src="../../assets/icon/Section/name.png" slot="label" alt="">
        </x-input>
        <x-input placeholder="请输入密码" type="password" v-model="password" :show-clear="false">

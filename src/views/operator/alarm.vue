...
<script>
import { Checker, CheckerItem, Datetime, XButton, Scroller ,Confirm,TransferDom} from "vux";
...
export default {
  ...
  mounted() {
       this.startDate = this.formatTime(new Date().setHours(-24*183), "YYYY-MM-DD ");
  ...
  methods: {
    ...
    // 查找按钮
    search() {
         var t1       = this.startime1||this.alarmpara.starttime.slice(0,10);
         var t2       = this.startime2 ||this.alarmpara.endtime .slice(0,10);
